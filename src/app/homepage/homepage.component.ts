...
@Component({
  ...
  template: `
   <div class="block has-background-success">
      ...
      <div class="tile">
        ...
        <div class="tile is-parent">
          <article class="tile is-child notification is-success">
            ...
            <p class="subtitle">From organic vegetable gardens to colorful flower beds, shop our expert curated list of tools, seeds, and supplies you'll need to get growing. </p>
            <figure class="image is-4by3">
    ...
    <div class="tile">
        <div class="tile is-parent">
          <article class="tile is-child notification is-success">
            ...
            <p class="subtitle">Whether you're a seasoned gardener or just starting out, this featuer will help you make informed decisions about which plants to choose for your garden.</p>
              <img src="assets/Images/seedlings-2022-11-07-21-42-35-utc.jpg">
          </article>
        </div>
      </div>
    </div>
